odoo.define('tis_hr_attendance_geolocalize.kiosk_mode_geo_location', function (require) {
    "use strict";
      ...
      update_attendance_kiosk(){
        ...
        attendance_fetch(position){
            ...
            this._rpc({
                ...
                args: [[this.employee_id], 'hr_attendance.hr_attendance_action_my_attendances', null, [emp_latitude, emp_longitude]],
            })
            .then(function(result) {
                if (result.action) {
                    self.do_action(result.action);
